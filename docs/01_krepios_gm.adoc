...
When opening the GM screen you can find the area of operations by scrolling to sector `O13`, about 8 sectors out you
can find the asteroid belt. As the placement is random you might have to browse a little.
