My.Translator:register("en", {
    products_ore_name = "Ore",
    products_ore_description = "A highly enriched mineral extracted from asteroids is sold as ore. To be useful, it must be further processed and serves as an important raw material for a large part of the mining industry.",
    products_plutoniumOre_name = "Plutonium Ore",
    products_plutoniumOre_description = "Plutonium ore is used as a raw material for autonomous power cells and high-energy weapons. Its kinetic explosive power is unmatched.",
    products_miningMachinery_name = "mining machinery",
