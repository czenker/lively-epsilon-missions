...
My.Translator:register("de", {
    ...
    side_mission_transport_description = function(amount, productName, toCallSign, payment, penalty)
        return f("Unsere Kollegen von %s haben uns gebeten ihnen eine Ladung %s zu schicken.\n\nWir suchen daher einen Kurier, der %d Einheiten %s ausliefern kann. Wir zahlen für die Auslieferung %0.2fRP. Außerdem erheben wir eine Kaution in Höhe von %0.2fRP - nur für den Fall, dass sie auf die Idee kommen sollten unsere Waren auf dem freien Markt zu verkaufen.", toCallSign, productName, amount, productName, payment, penalty)
    end,
    side_mission_transport_product_no_storage = "Ihr Schiff hat keinen Laderaum. Ich hoffe, Sie haben Verständnis, dass wir diesen Auftrag darum nicht an Sie vergeben werden.",
    ...
    side_mission_transport_product_no_penalty = "Sie sind im Augenblick nicht in der Lage die Kaution zu übernehmen. Wir können diesen Auftrag darum leider nicht an Sie vergeben.",
    ...
    side_mission_transport_product_success = function(payment)
        return f("Vielen Dank für die Lieferung. Wir haben Ihnen die Bezahlung in Höhe von %0.2fRP sowie die Kaution überwiesen. Wenn Sie wieder einen Auftrag suchen melden Sie sich bei uns.", payment)
    end,
})