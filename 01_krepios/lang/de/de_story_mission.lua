...
My.Translator:register("de", {
    story_welcome_1 = function(commanderPerson, colonelPerson)
        ...
        Seid ihr die kleinen Gruenschnaebel, die Colonel " .. colonelPerson:getFormalName() .. " \z
        geschickt hat, um auf mich aufzupassen?"
    end,
    story_welcome_1_response_good = "Jawoll Sir. Wir melden uns zum Dienst.",
    story_welcome_1_response_bad = "Hey, wir sind keine Gruenschnaebel!",

    story_welcome_2_good = "Hah. So wie ihr redet habt ihr an der Akademie den Streber-Kurs mit Bravour bestanden. Das koennt ihr \z
        euch hier gleich abgewoehnen, euer Gelaber interessiert hier niemanden.",
    story_welcome_2_bad = function(colonelPerson)
        return "Oh mein Gott. Natuerlich seid ihr keine Gruenschnaebel, sondern ein Haufen Heulsusen. Wegen mir koennt ihr \z
    ...
    story_welcome_2 = function(colonelPerson)
        return "Aber mal zum Punkt: Mir ist es scheissegal, ob ihr hier seid oder nicht. Ich brauch euch nicht, ich \z
        habe euch nicht angefordert. Colonel " .. colonelPerson:getFormalName() .. " hielt es fuer eine gute Idee euch \z
        hier her zu schicken, weil wir hier so weit draussen sind und bestimmt Hilfe brauchen. Als ob wir hier nicht \z
        allein klar kaemen."
    end,
    story_welcome_2_response_good = "Vielleicht koennen wir uns ja doch als nuetzlich erweisen",
    ...
    story_welcome_3_good = "Nuetzlich wie ein paar Kinder, die dir am Hosenbein haengen? Ja, das bestimmt.",
    story_welcome_3_bad = "[sarkastisch] Ja natuerlich hat sich der feine Herr was dabei gedacht. Unsere Situation \z
        laesst sich ja hervorragend aus ein paar 1000u einschaetzen.",
    story_welcome_3 = "Mit der Drecksmuehle, die ihr fliegt werdet ihr sicher nicht lange Freude haben, wenn ihr sie \z
    ...
    story_welcome_3_response_bad = "Koennen wir uns von ihnen Geld leihen?",

    story_welcome_4_good = "Viele sind hier auf der Suche nach Arbeit. Die meisten sind Schuerfer, aber ein paar andere \z
        Aufgaben gibt es hier auch noch.",
    story_welcome_4_bad = "Wir sind hier nicht bei der Wohlfahrt, Maedchen! Hier wohnen Menschen, die dir die Kehle \z
        aufschlitzen um sich einen Drink leisten zu koennen. RP musst du dir hier selbst erarbeiten.",
    story_welcome_4 = "Am besten schaut ihr mal bei den umliegenden Schürfstationen im Asteroidenguertel vorbei. Dort gibt es \z
        gelegentlich Autraege. Und wenn ihr auf dem Weg zu ihnen seid, nehmt Energiezellen und Baumaschinen mit - das brauchen \z
        die dort immer.",
    story_welcome_4_response_good = "Ok, wir machen uns dann mal auf dem Weg",
    story_welcome_4_response_bad = "Eine Frage haetten wir noch",
    ...
    story_drives_available = function(colonelPerson, commanderPerson, hqCallSign)
        ...
        euch einen Jump Antrieb oder Warp Antrieb zu installieren. Die Kosten rechnet er mit mir ab. Ich müsst euch aber \z
    ...
    story_laser_refit_award_comms = function(commanderPerson)
        return "Ihr scheint ja doch langsam im Sektor zurecht zu kommen. \z
    ...
    story_power_presets_award_comms = function(commanderPerson)
        ...
        Das Upgrade soll wohl eurem Technikoffizier irgendwie helfen. So ganz hab ich ihr Geblabber nicht verstanden, aber \z
    ...
    story_attack_detected_1 = function(commanderPerson, playerCallSign)
        ...
        stecken ganz tief in der Scheisse. Mehrere unindentifizierte Geschwader sind in diesem Sektor unterwegs und \z
    ...
    story_attack_detected_2 = "Ich habe keine Ahnung wo diese Kacksdinger her kommen und ich will es auch nicht \z
    ...
    story_evacuation_order_2_neutral = function(playerCallSign)
        return "Einverstanden.\n\nIch vertraue Ihnen und der Kenntnis Ihres Schiffs, " .. playerCallSign .. ". Kommen Sie wenn möglich heil zurück."
    end,
    ...
    story_mission_debrief = "Das Wurmloch nahe Krepios nutzen um zum Hauptquartier zurück zu kehren.",
    ...
    story_final_evacuation_debrief_survivors = function(playerCallSign, commanderPerson)
        ...
        Seite unzähliger Zivilisten, die er bis zu letzt geschützt hat. Dafür werde ich ihm posthum eine Ehrenmedaille \z
        verleihen.\n\n\z
    ...
    story_final_evacuation_debrief_heroic = function(playerCallSign, commanderPerson)
        return "Die Station ist in heller Aufregen und hat eurer Ankunft mit hoher Aufregung entgegen geeifert. \z
    ...
    story_final_evacuation_debrief_lost = function(playerCallSign, commanderPerson)
        ...
        Umso mehr stimmt es mich glücklich, dass wenigstens ihr es heil zurück geschafft habt. Wir werden jede Crew brauchen \z
        ...
        Doch für heute ist euer Dienst vorerst beendet. Wir haben das Wurmloch hinter euch geschlossen, so dass uns keine \z
    ...
    story_final_evacuation_debrief_unclear = function(playerCallSign, commanderPerson)
        ...
        Wir werden bald eine Flotte zusammenstellen, die sich dem unbekannten Feind entgegen stellen kann und nach \z
