...
examples("Example Military Station Names", My.militaryStationName)
examples("Example Wharf Station Names", My.wharfStationName)
examples("Example Droid Names", My.droidName)
